	...
	_, err := tx.Exec(EngineQuery(map[dbtypes.DBEngineType]string{
		dbtypes.DBEnginePgsql: `
			INSERT INTO slots (
				...
				proposer_tee_type, proposer_tee_quote
			...
			ON CONFLICT (slot, root) DO UPDATE SET
				...
				proposer_tee_type = excluded.proposer_tee_type,
				proposer_tee_quote = excluded.proposer_tee_quote`,
		...
		slot.ProposerTEEType, slot.ProposerTEEQuote)
	if err != nil {
		return err
	}
